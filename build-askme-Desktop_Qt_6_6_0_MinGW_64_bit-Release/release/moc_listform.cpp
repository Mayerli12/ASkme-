...
#include "../../../../../Escritorio/Qt mayerli campuez/askme/listform.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSListFormENDCLASS_t qt_meta_stringdata_CLASSListFormENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 25),  // "on_tblTermino_cellClicked"
        QT_MOC_LITERAL(48, 3),  // "row"
        QT_MOC_LITERAL(52, 6),  // "column"
        QT_MOC_LITERAL(59, 37),  // "on_cmbAsignaturas_currentInde..."
...
Q_CONSTINIT const QMetaObject ListForm::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSListFormENDCLASS_t,
        ...
        // method 'on_tblTermino_cellClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void ListForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_tblTermino_cellClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->on_cmbAsignaturas_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
